...
def optimize(imsim, fitting_kwargs_list=None) :
    ...
    lens_params = [imsim.lm_dict_opt['kwargs_init']['kwargs_lens'], imsim.lm_dict_opt['kwargs_sigma']['kwargs_lens'], imsim.lm_dict_opt['kwargs_fixed']['kwargs_lens'], imsim.lm_dict_opt['kwargs_lower']['kwargs_lens'], imsim.lm_dict_opt['kwargs_upper']['kwargs_lens']]
    source_params = [imsim.lm_dict_opt['kwargs_init']['kwargs_source'], imsim.lm_dict_opt['kwargs_sigma']['kwargs_source'], imsim.lm_dict_opt['kwargs_fixed']['kwargs_source'], imsim.lm_dict_opt['kwargs_lower']['kwargs_source'], imsim.lm_dict_opt['kwargs_upper']['kwargs_source']]
    ps_params = [imsim.lm_dict_opt['kwargs_init']['kwargs_source_ps'], imsim.lm_dict_opt['kwargs_sigma']['kwargs_source_ps'], imsim.lm_dict_opt['kwargs_fixed']['kwargs_source_ps'], imsim.lm_dict_opt['kwargs_lower']['kwargs_source_ps'], imsim.lm_dict_opt['kwargs_upper']['kwargs_source_ps']]
    ...
    kwargs_model = imsim.lm_dict_opt['models'].copy()
    kwargs_model['fixed_magnification_list'] = [ True for src in imsim.lm_dict_opt['models']['point_source_model_list'] ]
    ...
    if imsim.use_linear_solver :
        ...
        imsim.ImageLinearFit.image_linear_solve(kwargs_lens=imsim.LensModel_kwargs,
                                                    kwargs_source=imsim.lm_dict_opt['kwargs_opt']['kwargs_source'],
                                                    kwargs_lens_light=None,
                                                    kwargs_ps=imsim.lm_dict_opt['kwargs_opt']['kwargs_source_ps'],
                                                    inv_bool=False)
    
    imsim.lm_optimized = lenstronomy_model(imsim.lm_dict_opt, imsim, chain_list=imsim.chain_list)
